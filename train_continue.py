...
train_pkl_files = pkl_files[:600]
    #.extend(pkl_files[42:])
valid_pkl_files = pkl_files[610:620]
...
args.log_name = "./log_RNNModelAtt1SeperateEncoder_continue.txt"
# model_dir = base_dir + "/Data/wsdm2019/python/model/CNNModel/"
# model_dir = "/home/joey/Desktop/RNNModelAtt1SeperateEncoder/"
# model_dir = "/home/joey/Desktop/ensemble/RNNModelAtt1SeperateEncoder_6315/"
# model_dir = "/home/joey/Desktop/RNNModelAtt1_Double_LSTM/"
# model_dir = "/home/joey/Desktop/RNNModelAtt1SeperateEncoder/"
model_dir = "/home/joey/Desktop/RNNModelAtt1SeperateEncoder_Double_LSTM/"
...
with open(args.log_name, "a") as myfile:
    myfile.write("Loaded checkpoint: " + model_dir + 'model_best' + "\n")
    myfile.write('epoch: ' + str(checkpoint['epoch']) + "\n")
    myfile.write('acc: ' + str(checkpoint['current_acc']) + "\n")
    myfile.write("evaluation after loading " + "\n")
...
# temp! temporary! Delete!

# args.train_batch_size = 32
# train_pkl_files = ["/media/data2/Data/wsdm2019/python/log_mini.pkl"]
# model_dir = "/home/joey/Desktop/test_mini/"
...
for epoch in range(args.num_train_epochs):
    ...
    for train_pkl_file in train_pkl_files:
        with open(train_pkl_file, "rb") as f:
            ...
            # valid_examples = train_examples[int(0.75 * l):]
            # train_examples = train_examples[:int(0.75 * l)]
            ...
            if step % 1 == 0:
                ...
                if ap > best_acc:
                    ...
                    save_checkpoint({
                        ...
                        'current_acc': ap,
                    }, is_best, filename=model_dir+ "continue_train/" + 'epoch_'+str(epoch))
